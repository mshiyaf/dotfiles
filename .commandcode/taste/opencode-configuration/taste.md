...
- Cost-optimize model routing: use GPT-5.6 Luna Low for simple docs/commit text, Terra for everyday coding/testing, Sol for architecture/debugging/review, and Sol Pro only for highest-risk critique/security work. Confidence: 0.80
